...
async function showVersion() {
    ...
    if (serverUrl.value.trim() === ncc.serverUrl && 'undefined' !== typeof ncc.cloud_supported) {
        ...
        provider_name.textContent = ncc.cloud_productname || 'r7cloud';
        logo.src = {
            "r7-office": "images/r7-office-logo.svg",
            "r7office": "images/r7office-logo.svg",
        ...
        provider_name.textContent = 'r7cloud';
        logo.src = "../../icon48.png";
